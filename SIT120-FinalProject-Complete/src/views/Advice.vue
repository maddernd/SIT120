<template>
  <div class="advice" style="padding-left: 16px">
    ...
    <h4>{{ count }} times you have clicked the button</h4>
    ...
    <button class="VetsnearYou" @click="showDetails(); click=incrementCount" >
      Vets Close to you
    </button>
    <!--Button to search for Sharpei Fever links via Google API -->
    <button class="SharpeiFever" @click="showModal = false; click=incrementCount">
      Sharpei Fever Help
    </button>
