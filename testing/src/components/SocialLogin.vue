<template>
  <!-- This is the base component for sign up and sign in via google auth using the default Google sign up template design-->
  <div class="signup-buttons">
    ...
    <!-- This is the base component for sign up and sign invia facebook Auth using the default facebook auth box-->
...
//export login_signup_social
export default {
  name: "SocialLogin",
  mounted() {
    initFbsdk();
  },
  //Methods for Google and Facebook login
  methods: {
    loginWithGoogle() {
      this.$gAuth
        .signIn()
    ...
    //Section to login with Facebook
    loginWithFacebook() {
